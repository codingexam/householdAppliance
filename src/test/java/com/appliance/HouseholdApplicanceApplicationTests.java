...
class HouseholdApplicanceApplicationTests {
	...
	public void getAllAppliancesTest() {
		when(repository.findAll()).thenReturn(Stream
				.of(new Appliance(1L, 2L, "LG", "XYZ", "USING", LocalDate.now()),
						new Appliance(1L, 2L, "BRAND", "MODEL", "NOT IN USE", LocalDate.now())
	...
	public void getSingleAppliance() {
		long serialNum = 1L;
		Appliance appliance = new Appliance(1L, 2L, "LG", "XYZ", "USING", LocalDate.now());
	...
	public void updateAppliance() {
		Appliance updatedAppliance = new Appliance(1L, 2L, "LG", "XYZ", "USING", LocalDate.now());
